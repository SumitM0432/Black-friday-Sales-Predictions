...
#### • LINEAR REGRESSION - The Linear regression didn't gave a good RMSE score. The RMSE score was 4671.809
#### • POLYNOMIAL REGRESSION – The polynomial regression model of degree 2 and 3 also gave a RMSE score close to the linear regression. The RMSE score was 4374.074
#### • LASSO REGRESSION – The lasso Regression also gave a similar RMSE score but no improvement is seen in the RMSE score even after changing the max_iter and alpha parameters.
#### • BOOSTED GRADIENT DESCENT – Boosted Gradient decent regressor gave a good RMSE score of 2520.355. The parameters of the XGB regressor are varied as well to get a good RMSE score and the parameters used are:
